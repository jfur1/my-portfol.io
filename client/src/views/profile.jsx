...
export const Profile = props => {
    ...
    const [hiddenResume, setHiddenResume] = useState(false);
            ...
            <div className="container">
                ...
                <div className="user-container">
                    ...
                    <div className="btn-group-toggle profile-nav">
                        <button className="btn btn-outline-dark" onClick={() => { setHiddenAbout(true); setHiddenPosts(false); setHiddenPortfolio(false); setHiddenResume(false);}}>About</button>
                        <button className="btn btn-outline-dark" onClick={() => { setHiddenPosts(true); setHiddenAbout(false); setHiddenPortfolio(false); setHiddenResume(false);}}>Posts</button>
                        <button className="btn btn-outline-dark" onClick={() => { setHiddenPortfolio(true); setHiddenAbout(false); setHiddenPosts(false); setHiddenResume(false);}}>Portfolio</button>
                        <button className="btn btn-outline-dark" onClick={() => { setHiddenResume(true); setHiddenAbout(false); setHiddenPortfolio(false); setHiddenPosts(false);}}>Resume</button>
                    </div>
                </div>
                <div class="info-container">
                    ...
                    { hiddenPortfolio ?
                    <div className="portfolio-container"><p>Portfolio Content</p></div> : null}
                    { hiddenResume ?
